...
import { SEARCH_PROPOSITION } from "@/lib/scenes/search-scene-config";
import { CursorTrigger } from "@/providers/CursorContext";

interface SearchCapabilityRevealProps {
  progress: number; // 0.0 to 1.0
}

export function SearchCapabilityReveal({ progress }: SearchCapabilityRevealProps) {
