    ...
    <div className="w-full bg-avorria-black px-6 sm:px-12 py-32 max-w-[1760px] mx-auto select-none space-y-16">
      <div className="space-y-4 border-b border-avorria-line pb-8">
        <span className="font-mono text-xs text-avorria-signal uppercase tracking-widest">
          08 / FINALE <span>{"//"}</span> ACTION
        </span>
        <h3 className="font-display font-extrabold text-3xl sm:text-5xl uppercase tracking-tight text-avorria-white leading-tight whitespace-pre-line">
          {FINALE_CONFIG.questionText}
        </h3>
      </div>

      <div>
        <h2 className="font-display font-extrabold uppercase tracking-tight leading-[0.88] text-avorria-white whitespace-pre-line"
      ...
      <div className="pt-12 border-t border-avorria-line flex flex-col md:flex-row md:items-center justify-between gap-6">
        <Link
          ...
          className="text-2xl sm:text-4xl font-display font-extrabold uppercase text-avorria-signal hover:text-avorria-white transition-colors inline-flex items-center gap-3"
        >
