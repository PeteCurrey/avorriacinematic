...
export const BUILD_FRAGMENTS: BuildFragmentConfig[] = [
  {
    ...
    svgPath: "/media/projects/careeros/hero/hero_career_world_desktop.jpg",
    initialX: 60,
    initialY: 40,
    assembledX: 5,
    assembledY: 10,
  ...
  },
  {
    ...
    svgPath: "/media/projects/nestiq/interface/agent-dashboard-preview.png",
    initialX: 110,
    initialY: 10,
    assembledX: 51,
    assembledY: 10,
  ...
  },
  {
    ...
    svgPath: "/media/projects/drawdown/interface/dashboard.png",
    initialX: -40,
    initialY: 60,
    assembledX: 5,
    assembledY: 54,
  ...
  },
  {
    ...
    svgPath: "/media/projects/entirefm/entirefm-operational.svg",
    initialX: 110,
    initialY: 70,
    assembledX: 35,
    assembledY: 54,
  ...
  },
  {
    ...
    svgPath: "/media/projects/alkota/product/naked-carbon-hero.jpg",
    initialX: 50,
    initialY: 120,
    assembledX: 69,
    assembledY: 54,
