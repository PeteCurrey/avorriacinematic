  ...
  return (
    <div className="max-w-[1720px] mx-auto px-6 sm:px-10 lg:px-16 pt-32 pb-24">
      <div className="flex items-center gap-3 mb-8 font-mono text-xs">
        <Link href="/lab" className="text-avorria-muted hover:text-avorria-white">
          Lab
        </Link>
        <span className="text-avorria-line-strong">/</span>
        <span className="text-avorria-signal uppercase">{slug}</span>
      </div>
      <h1 className="display-md uppercase text-avorria-white">Experiment // {slug}</h1>
      <p className="font-mono text-xs text-avorria-muted mt-4">Lab experiment container initialized.</p>
    </div>
  );
}
