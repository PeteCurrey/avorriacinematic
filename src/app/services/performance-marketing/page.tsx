...
export async function generateMetadata() {
  const service = getServiceBySlug("performance-marketing");
  if (!service) return {};
  ...
  return (
    <main className="w-full min-h-screen bg-avorria-black text-avorria-white">
      ...
      <ServiceDeliverablesMatrix
        sectionEyebrow="01 // GROWTH CAPABILITIES"
      ...
      <ServiceProblemsSolved
        sectionEyebrow="02 // CONVERSION FRICTION"
      ...
      <ServiceMethodology
        sectionEyebrow="03 // PERFORMANCE FRAMEWORK"
        sectionTitle="HOW AVORRIA APPROACHES GROWTH"
        steps={service.methodology}
      />

      {/* 05 // Selected Proof in Production */}
      <ServiceProofShowcase
        sectionEyebrow="04 // COMMERCIAL EVIDENCE"
        sectionTitle="SELECTED GROWTH CAMPAIGNS"
